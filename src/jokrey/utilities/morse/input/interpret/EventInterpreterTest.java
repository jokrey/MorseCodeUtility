...
public class EventInterpreterTest {
    ...
    public static void run_sure_universal_tests(EventInterpreter interpreter) {
        String[] test_cases = {"hallo", /*"eee", "ttt",*/ "What are you talking boat?", "Canadians. Duh", "abcdefghijklmnopqrstuvwxyz0123456789", "0123456789", "0", "ete"};
...
//            System.out.println("signals_but_as_doubles.l: "+signals_but_as_doubles.size());
            ...
            pure_test(interpreter, signals_but_as_doubles, test_case.toLowerCase());
        }
    }
    /**
     * Every second 'pure_input_switch_wait_time' is interpreted as a pause. The first one is a signal.
     */
    public static void pure_test(EventInterpreter interpreter, List<Double> pure_input_switch_wait_times, String expected_output) {
        ...
        assertEquals(expected_output, interpreter_output);
    }
